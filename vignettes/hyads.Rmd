...
yearmons <- paste0( runyear, 1:12)
linked_zips <- lapply( yearmons,
hyspdisp_zip_link,
duration_run_hours = run_hours,
hpbl_raster = pbl_rasterin,
zcta2 = zcta2,
crosswalk = cw,
unit = unit,
zpc_dir = ziplink_dir,
